...
static const Node g_data[COUNT] = {
    ...
    {"FastNoise2D", "Noise", "Returns computation of 2D noise at coordinates [code](x, y)[/code] using the FastNoiseLite library. The [code]noise[/code] parameter is specified with an instance of the [url=VOXEL_FastNoiseLite]VOXEL_FastNoiseLite[/url] resource.\nNote: this node might be a little faster than [code]Noise2D[/code]."},
    ...
    {"FastNoise3D", "Noise", "Returns computation of 3D noise at coordinates [code](x, y, z)[/code] using the FastNoiseLite library. The [code]noise[/code] parameter is specified with an instance of the [url=VOXEL_FastNoiseLite]VOXEL_FastNoiseLite[/url] resource.\nNote: this node might be a little faster than [code]Noise3D[/code]."},
